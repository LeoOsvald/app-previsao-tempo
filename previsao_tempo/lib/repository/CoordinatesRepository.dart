...
class CoordinatesRepositoryImpl{
  ...
  Future<Result<List<Coordinates>>> getCoordinates(cityName,limit,apiKey) async{
    try
    {
      var cities = await api.getCityData(cityName, limit, apiKey);
...
abstract class CoordinatesRepository {
  Future<Result<List<Coordinates>>> getCoordinates(q, limit, appid);
}